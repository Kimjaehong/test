    ...
    _markup =
        '<div class="ui-widget-header ui-helper-clearfix ui-corner-all">' +
            '<table class="month-picker-year-table" width="100%" border="0" cellspacing="1" cellpadding="2">' +
                '<tr>' +
                    ...
                    '<td class="year-container-all" style="width:100%; text-align:center">' +
                        '<div id="year-container" style="width:100%; text-align:center"><span class="year"></span><span class="year-title"></span></div>' +
                    '</td>' +
        ...
        '<div class="ui-widget ui-widget-content ui-helper-clearfix ui-corner-all">' +
            '<table class="month-picker-month-table" width="100%" border="0" cellspacing="1" cellpadding="2">' +
                '<tr>' +
                    '<td><button class="button-1 btn-w48" type="button"></button></td>' +
                    '<td><button class="button-2 btn-w48" type="button"></button></td>' +
                    '<td><button class="button-3 btn-w48" type="button"></button></td>' +
                '</tr>' +
                '<tr>' +
                    '<td><button class="button-4 btn-w48" type="button"></button></td>' +
                    '<td><button class="button-5 btn-w48" type="button"></button></td>' +
                    '<td><button class="button-6 btn-w48" type="button"></button></td>' +
                '</tr>' +
                '<tr>' +
                    '<td><button class="button-7 btn-w48" type="button"></button></td>' +
                    '<td><button class="button-8 btn-w48" type="button"></button></td>' +
                    '<td><button class="button-9 btn-w48" type="button"></button></td>' +
                '</tr>' +
                '<tr>' +
                    '<td><button class="button-10 btn-w48" type="button"></button></td>' +
                    '<td><button class="button-11 btn-w48" type="button"></button></td>' +
                    '<td><button class="button-12 btn-w48" type="button"></button></td>' +
                '</tr>' +
            '</table>' +
        '</div>';
    ...
    $.widget("KidSysco.MonthPicker", {
        ...
        _showMonths: function () {
            ...
            for (var _month in _months) {
                ...
                $('.button-' + _counter, this._monthPickerMenu).html(_months[_month]);
            }
        },
