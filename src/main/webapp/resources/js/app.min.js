...
function runAllForms() {
    $.fn.slider && $(".slider").slider(), $.fn.select2 && $("select.select2").each(function() {
        ...
        $.fn.autocomplete && $("[data-autocomplete]").each(function() {
            ...
            var e = $(this),
                t = e.attr("data-dateformat") || "yy-mm-dd";
            e.datepicker({
                dateFormat: t,
...
function runAllCharts() {
    if ($.fn.sparkline) {
        var e, t, a, o, i, n, r, l, s, d, c, h, p, u, f, g, m, v, b, k, w, C, y, x, _, S, A, R, M, j, D, L, T, F, W, B, E, z, N, O, P, U, q, I, J, Y, H, V, X, Q, K, G, Z, et, tt, at, ot, it, nt, rt, lt, st, dt, ct, ht, pt, ut, ft, gt, mt, vt, $t;
        $(".sparkline:not(:has(>canvas))").each(function() {
            var bt = $(this),
                kt = bt.data("sparkline-type") || "bar";
            if ("bar" == kt && (e = bt.data("sparkline-bar-color") || bt.css("color") || "#0000f0", t = bt.data("sparkline-height") || "26px", a = bt.data("sparkline-barwidth") || 5, o = bt.data("sparkline-barspacing") || 2, i = bt.data("sparkline-negbar-color") || "#A90329", n = bt.data("sparkline-barstacked-color") || ["#A90329", "#0099c6", "#98AA56", "#da532c", "#4490B1", "#6E9461", "#990099", "#B4CAD3"], bt.sparkline("html", {
                    barColor: e,
                    type: kt,
                    height: t,
                    barWidth: a,
                ...
                }), bt = null), "pie" == kt && (g = bt.data("sparkline-piecolor") || ["#B4CAD3", "#4490B1", "#98AA56", "#da532c", "#6E9461", "#0099c6", "#990099", "#717D8A"], m = bt.data("sparkline-piesize") || 90, v = bt.data("border-color") || "#45494C", b = bt.data("sparkline-offset") || 0, bt.sparkline("html", {
                    type: "pie",
                    width: m,
                    height: m,
                    ...
                    offset: b,
                    borderColor: v
                }), bt = null), "box" == kt && (k = bt.data("sparkline-width") || "auto", w = bt.data("sparkline-height") || "auto", C = bt.data("sparkline-boxraw") || !1, y = bt.data("sparkline-targetval") || "undefined", x = bt.data("sparkline-min") || "undefined", _ = bt.data("sparkline-max") || "undefined", S = bt.data("sparkline-showoutlier") || !0, A = bt.data("sparkline-outlier-iqr") || 1.5, R = bt.data("sparkline-spotradius") || 1.5, M = bt.css("color") || "#000000", j = bt.data("fill-color") || "#c0d0f0", D = bt.data("sparkline-whis-color") || "#000000", L = bt.data("sparkline-outline-color") || "#303030", T = bt.data("sparkline-outlinefill-color") || "#f0f0f0", F = bt.data("sparkline-outlinemedian-color") || "#f00000", W = bt.data("sparkline-outlinetarget-color") || "#40a020", bt.sparkline("html", {
                    type: "box",
                    width: k,
                    height: w,
                    raw: C,
                ...
                var wt = bt.data("sparkline-height") || "auto";
                B = bt.data("sparkline-width") || 2, E = bt.data("sparkline-bullet-color") || "#ed1c24", z = bt.data("sparkline-performance-color") || "#3030f0", N = bt.data("sparkline-bulletrange-color") || ["#d3dafe", "#a8b6ff", "#7f94ff"], bt.sparkline("html", {
                    type: "bullet",
                    height: wt,
                    targetWidth: B,
                    targetColor: E,
            ...
            "discrete" == kt && (O = bt.data("sparkline-height") || 26, P = bt.data("sparkline-width") || 50, U = bt.css("color"), q = bt.data("sparkline-line-height") || 5, I = bt.data("sparkline-threshold") || "undefined", J = bt.data("sparkline-threshold-color") || "#ed1c24", bt.sparkline("html", {
                type: "discrete",
                width: P,
                height: O,
                lineColor: U,
                ...
                thresholdValue: I,
                thresholdColor: J
            }), bt = null), "tristate" == kt && (Y = bt.data("sparkline-height") || 26, H = bt.data("sparkline-posbar-color") || "#60f060", V = bt.data("sparkline-negbar-color") || "#f04040", X = bt.data("sparkline-zerobar-color") || "#909090", Q = bt.data("sparkline-barwidth") || 5, K = bt.data("sparkline-barspacing") || 2, G = bt.data("sparkline-zeroaxis") || !1, bt.sparkline("html", {
                type: "tristate",
                height: Y,
                posBarColor: Z,
                negBarColor: V,
                ...
                barSpacing: K,
                zeroAxis: G
            }), bt = null), "compositebar" == kt && (t = bt.data("sparkline-height") || "20px", et = bt.data("sparkline-width") || "100%", a = bt.data("sparkline-barwidth") || 3, l = bt.data("sparkline-line-width") || 1, r = bt.data("data-sparkline-linecolor") || "#ed1c24", Z = bt.data("data-sparkline-barcolor") || "#333333", bt.sparkline(bt.data("sparkline-bar-val"), {
                type: "bar",
                width: et,
                height: t,
                barColor: Z,
                ...
                composite: !0,
                fillColor: !1
            }), bt = null), "compositeline" == kt && (t = bt.data("sparkline-height") || "20px", et = bt.data("sparkline-width") || "90px", tt = bt.data("sparkline-bar-val"), at = bt.data("sparkline-bar-val-spots-top") || null, ot = bt.data("sparkline-bar-val-spots-bottom") || null, it = bt.data("sparkline-line-width-top") || 1, nt = bt.data("sparkline-line-width-bottom") || 1, rt = bt.data("sparkline-color-top") || "#333333", lt = bt.data("sparkline-color-bottom") || "#ed1c24", st = bt.data("sparkline-spotradius-top") || 1.5, dt = bt.data("sparkline-spotradius-bottom") || st, d = bt.data("sparkline-spot-color") || "#f08000", ct = bt.data("sparkline-minspot-color-top") || "#ed1c24", ht = bt.data("sparkline-maxspot-color-top") || "#f08000", pt = bt.data("sparkline-minspot-color-bottom") || ct, ut = bt.data("sparkline-maxspot-color-bottom") || ht, ft = bt.data("sparkline-highlightspot-color-top") || "#50f050", gt = bt.data("sparkline-highlightline-color-top") || "#f02020", mt = bt.data("sparkline-highlightspot-color-bottom") || ft, thisHighlightLineColor2 = bt.data("sparkline-highlightline-color-bottom") || gt, vt = bt.data("sparkline-fillcolor-top") || "transparent", $t = bt.data("sparkline-fillcolor-bottom") || "transparent", bt.sparkline(tt, {
                type: "line",
                spotRadius: st,
                spotColor: d,
                minSpotColor: ct,
                maxSpotColor: ht,
                highlightSpotColor: ft,
                highlightLineColor: gt,
                valueSpots: at,
                lineWidth: it,
                width: et,
                height: t,
...
function checkURL() {
    ...
    if (container = $("#content"), e) {
        ...
        $("nav li.open").each(function() {
            $(this).hasClass("active") || ($(this).removeClass("open"), $(this).find("ul").css("display", "none"), $(this).find("em").removeClass("fa-minus-square-o").addClass("fa-plus-square-o"))
...
function loadURL(e, t) {
	console.log("loadURL");
    e = cf_xssFilter(e), debugState && root.root.console.log("Loading URL: %c" + e, debugStyle), 
    $.ajax({
        type: "GET",
        url: e,
        dataType: "html",
        ...
        cache: !0,
        beforeSend: function() {
            if (t.removeData().html(""), $.navAsAjax && $.intervalArr.length > 0 && t[0] == $("#content")[0] && enableJarvisWidgets) {
            ...
            pagefunction = null, 
            t.removeData().html(""), 
            t.html('<h1 class="ajax-loading-animation"><i class="fa fa-cog fa-spin"></i> Loading...</h1>'), 
            t[0] == $("#content")[0] && ($("body").find("> *").filter(":not(" + ignore_key_elms + ")").empty().remove(), 
            		drawBreadCrumb(), 
            		$("html").animate({
                scrollTop: 0
            }, "fast"))
        ...
        error: function(e, a, o, i) {
            cf_errView(e, a, o, i, t)
        },
        async: !0
    })
}
    ...
    function(e, t, a) {
            ...
            i = t[l](function() {
                n.each(function() {
                    ...
                    try {
                        ...
                        a = o.height
                    }(t !== i.w || a !== i.h) && o.trigger(s, [i.w = t, i.h = a])
                }), o()
            }, r[c])
        }
        var i, n = e([]),
        ...
        r[c] = throttle_delay, r[h] = !0, e.event.special[s] = {
            ...
            teardown: function() {
                if (!r[h] && this[l]) return !1;
                var t = e(this);
                n = n.not(t), t.removeData(d), n.length || clearTimeout(i)
            },
            add: function(t) {
                function o(t, o, n) {
                    var r = e(this),
                        l = e.data(this, d);
                    l.w = o !== a ? o : r.width(), l.h = n !== a ? n : r.height(), i.apply(this, arguments)
                }
                if (!r[h] && this[l]) return !1;
                var i;
...
$.navAsAjax && (location.href.indexOf("#") < 0 && "" != init_page && (window.location.hash = init_page), $("nav").length && checkURL(), $(document).on("click", 'nav a[href!="#"]', function(e) {
    e.preventDefault();
    var t = $(e.currentTarget);
    t.attr("target") || ($.root_.hasClass("mobile-view-activated") ? ($.root_.removeClass("hidden-menu"), $("html").removeClass("hidden-menu-mobile-lock"), window.setTimeout(function() {
    ...
    }, 150)) : window.location.search ? window.location.href = window.location.href.replace(window.location.search, "").replace(window.location.hash, "") + "#" + t.attr("href") : (window.location.hash = t.attr("href"), checkURL()))
